...
if(NOT HAVE_FFMPEG AND PKG_CONFIG_FOUND)
  ...
  if(FFMPEG_FOUND)
    ocv_check_modules(FFMPEG_libswresample libswresample) # optional
    if(FFMPEG_libswresample_FOUND)
      list(APPEND FFMPEG_LIBRARIES ${FFMPEG_libswresample_LIBRARIES})
      list(APPEND _used_ffmpeg_libraries libswresample)
    endif()
    set(HAVE_FFMPEG TRUE)
  else()
...
if(HAVE_FFMPEG AND NOT HAVE_FFMPEG_WRAPPER)
  ...
  set(_min_libswresample_version 1.0.1)
  ...
  unset(_min_libswresample_version)
endif()
